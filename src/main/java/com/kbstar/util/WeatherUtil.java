...
public class WeatherUtil {
	public static String getWeather1(String loc) throws Exception {
		...
		urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") +
				"=3AMHAiXgyJXWmq6nAq%2BSyRV2EpnFTtjrjxNzYjeZpV%2Bb6pzeBKIRKg5SWGd2JvwNSvqg9zVfuufg%2B0J8naX2kQ%3D%3D"); /*Service Key*/
...
//		return result;
	...
	public static Object getWeather3(String loc) throws Exception {
		...
		urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=3AMHAiXgyJXWmq6nAq%2BSyRV2EpnFTtjrjxNzYjeZpV%2Bb6pzeBKIRKg5SWGd2JvwNSvqg9zVfuufg%2B0J8naX2kQ%3D%3D"); /*Service Key*/
